...
final String imagePath = 'images/yuji_friends/inoue_takashi_image.jpg';
final String iconPath = 'images/yuji_friends/inoue_takashi_icon.jpg';
final String name = '井上 たかし';
final String living = '千葉';
final String account = '@inoue_takashi';
final String message = '''
ゆうじ結婚おめでとう！！！
イケメン燃えてるヘッドはいつも俺の憧れでした♡
...
class PostItemInoueTakashi extends StatefulWidget {
  @override
