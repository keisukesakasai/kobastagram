...
final String imagePath = 'images/yuji_friends/yoshida_rio_image.jpg';
final String iconPath = 'images/yuji_friends/yoshida_rio_icon.jpg';
final String name = '吉田莉緒(武田莉緒)';
final String living = '南柏';
final String account = '@yoshida_rio';
final String message = '結婚おめでとう〜！㊗\n'
'なんやかんや12年間学校が一緒だったらしく、アルバムを見返してて懐かしかったです。\n'
'これからはまゆさんと仲良く楽しんでね☆\n';
...
class PostItemYoshidaRio extends StatefulWidget {
  @override
