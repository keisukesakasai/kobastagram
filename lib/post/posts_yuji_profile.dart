                  ...
                  children: [
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          ...
                                          CircleAvatar(
                                            radius: 45,
                                            backgroundImage: AssetImage('images/yuji_profile_icon.png'),
                                          ),
                                        ],
                                      ),
                                    ],
                    ...
                    Row(
                      children: [
                        ...
                        Text('フォロワー:',style: TextStyle(fontSize: 13),),
                        Flexible(
                          child: Text('saka_kei, kennn405, ekedadadadada, 他',
                            style: TextStyle(
                              fontSize: 13,
                              fontWeight: FontWeight.bold,
                            ),
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  CircleAvatar(
                                    radius: 30,
                                    backgroundImage: AssetImage('images/yuji_profile_icon.png'),//Story投稿画像
                                  ),
                              ...
                              Column(   //Icon行
                                children: [
                                  Container(
                                      ...
                                      child: Column(
                                        children: [
                                          Text('長距離も短距離も早く',style: TextStyle(fontSize: 12,),),
                                          Text('黄色い声援を浴びていた',style: TextStyle(fontSize: 12,),),
                                          Text('勉強もでき、学級で常に上位の成績',style: TextStyle(fontSize: 12,),),
                                         ],
                                      )),
                                  Container(
                                      padding: EdgeInsets.symmetric(horizontal: 1),
                                    ...
                                    Container(
                                      child: Row(
                                        ...
                                        children: [
                                          Row(
                                          children: [
                                            Icon(Icons.favorite_outline_outlined,size:15),
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  CircleAvatar(
                                    radius: 30,
                                    backgroundImage: AssetImage('images/yuji_profile_high_icon.jpg'),//Story投稿画像
                                  ),
                              ...
                              Column(   //Icon行
                                children: [
                                  Container(
                                      ...
                                      child: Column(
                                        children: [
                                          Text('サッカー部でエースの存在',style: TextStyle(fontSize: 12,),),
                                          Text('勉強も部活も文武両道で優等生',style: TextStyle(fontSize: 12,),),
                                          Text('早弁して昼休みは格闘フットサル',style: TextStyle(fontSize: 12,),),
