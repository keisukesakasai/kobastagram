...
class StoryItemMayuDad extends StatelessWidget {
  final String name;
  final IconData icon;

  StoryItemMayuDad({Key? key, required this.name, required this.icon})
      : super(key: key);
          ...
          child: Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                    image: AssetImage('images/story_icon/mayu_dad_icon.png'),
                    fit: BoxFit.cover),
              )),
        ),
